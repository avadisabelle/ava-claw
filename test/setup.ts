...
process.env.AVACLAW_PLUGIN_MANIFEST_CACHE_MS ??= "60000";
...
// Set HOME/state isolation before importing any runtime AvaClaw modules.
...
const createStubPlugin = (params: {
  ...
  config: {
    ...
    isConfigured: async (_account, cfg: AvaClawConfig) => {
      const channels = cfg.channels as Record<string, unknown> | undefined;
