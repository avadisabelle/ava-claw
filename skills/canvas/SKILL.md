...
Display HTML content on connected AvaClaw nodes (Mac app, iOS, Android).
...
```
http://<tailscale-hostname>:18793/__avaclaw__/canvas/<file>.html
```
...
- **loopback**: `http://127.0.0.1:18793/__avaclaw__/canvas/<file>.html`
- **lan/tailnet/auto**: `http://<hostname>:18793/__avaclaw__/canvas/<file>.html`
...
```
canvas action:present node:mac-63599bc4-b54d-4392-9048-b97abd58343a target:http://peters-mac-studio-1.sheep-coho.ts.net:18793/__avaclaw__/canvas/snake.html
```
...
Node is offline. Use `avaclaw nodes list` to find online nodes.
...
The canvas host serves from `/__avaclaw__/canvas/` prefix:

```
http://<host>:18793/__avaclaw__/canvas/index.html  → ~/clawd/canvas/index.html
http://<host>:18793/__avaclaw__/canvas/games/snake.html → ~/clawd/canvas/games/snake.html
```

The `/__avaclaw__/canvas/` prefix is defined by `CANVAS_HOST_PATH` constant.
