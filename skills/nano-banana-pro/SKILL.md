...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.avadisabelle/ava-claw.json`
...
- The script prints a `MEDIA:` line for AvaClaw to auto-attach on supported chat providers.
