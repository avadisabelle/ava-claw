...
**Current**: Autonomous AI agents operate under policy constraints (rate limits, permission scopes, safety filters) but lack *relational governance* — no mechanism asks "who does this affect?" or "is this serving the relationship or just completing a task?" before acting.
