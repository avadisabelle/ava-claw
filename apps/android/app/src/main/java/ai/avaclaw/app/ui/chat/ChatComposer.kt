...
import ai.avaclaw.app.ui.mobileSurface
import ai.avaclaw.app.ui.mobileText
import ai.avaclaw.app.ui.mobileTextSecondary
import ai.avaclaw.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.avaclaw.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.avaclaw.app.ui.mobileFontFamily,
