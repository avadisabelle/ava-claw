...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: AvaClawProtocol.AnyCodable]?
    {
        ...
        return [
            "id": AvaClawProtocol.AnyCodable(identity.deviceId),
            "publicKey": AvaClawProtocol.AnyCodable(publicKey),
            "signature": AvaClawProtocol.AnyCodable(signature),
            "signedAt": AvaClawProtocol.AnyCodable(signedAtMs),
            "nonce": AvaClawProtocol.AnyCodable(nonce),
        ]
    }
}
