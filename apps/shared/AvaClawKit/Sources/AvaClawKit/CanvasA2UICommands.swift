...
public enum AvaClawCanvasA2UICommand: String, Codable, Sendable {
...
public struct AvaClawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct AvaClawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
