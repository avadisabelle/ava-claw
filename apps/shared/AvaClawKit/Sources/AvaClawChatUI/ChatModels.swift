...
public typealias AvaClawPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias AvaClawPlatformImage = UIImage
#endif

public struct AvaClawChatUsageCost: Codable, Hashable, Sendable {
...
public struct AvaClawChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: AvaClawChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(AvaClawChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct AvaClawChatMessageContent: Codable, Hashable, Sendable {
...
public struct AvaClawChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [AvaClawChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: AvaClawChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [AvaClawChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: AvaClawChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(AvaClawChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([AvaClawChatMessageContent].self, forKey: .content) {
...
public struct AvaClawChatHistoryPayload: Codable, Sendable {
...
public struct AvaClawSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct AvaClawSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [AvaClawSessionPreviewItem]
}

public struct AvaClawSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [AvaClawSessionPreviewEntry]

    public init(ts: Int, previews: [AvaClawSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct AvaClawChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct AvaClawChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct AvaClawAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct AvaClawChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct AvaClawGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct AvaClawPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: AvaClawPlatformImage?
...
public struct AvaClawChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
