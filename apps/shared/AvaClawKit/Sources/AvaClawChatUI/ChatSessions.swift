...
public struct AvaClawChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct AvaClawChatSessionsDefaults: Codable, Sendable {
...
public struct AvaClawChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct AvaClawChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: AvaClawChatSessionsDefaults?
    public let sessions: [AvaClawChatSessionEntry]
    ...
    public init(
        ...
        sessions: [AvaClawChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
