...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: AvaClawPhotosLatestParams) async throws -> AvaClawPhotosLatestPayload {
        ...
        var results: [AvaClawPhotoPayload] = []
        ...
        return AvaClawPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> AvaClawPhotoPayload
    {
