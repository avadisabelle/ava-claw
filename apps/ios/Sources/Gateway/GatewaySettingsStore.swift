...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.avaclaw.gateway"
    private static let nodeService = "ai.avaclaw.node"
    private static let talkService = "ai.avaclaw.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.avaclaw.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.avaclaw.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("avaclaw-gateway.log")
    }
