...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.avaclaw.ios", category: "LiveActivity")
    private var currentActivity: Activity<AvaClawActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = AvaClawActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<AvaClawActivityAttributes>.activities
    ...
    private func updateCurrent(state: AvaClawActivityAttributes.ContentState) {
    ...
    private func connectingState() -> AvaClawActivityAttributes.ContentState {
        AvaClawActivityAttributes.ContentState(
    ...
    private func idleState() -> AvaClawActivityAttributes.ContentState {
        AvaClawActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> AvaClawActivityAttributes.ContentState {
        AvaClawActivityAttributes.ContentState(
