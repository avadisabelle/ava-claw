...
ASC_KEYCHAIN_SERVICE=avaclaw-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.avaclaw.client
# or
...
- The beta flow regenerates `apps/ios/AvaClaw.xcodeproj` from `apps/ios/project.yml` before archiving
