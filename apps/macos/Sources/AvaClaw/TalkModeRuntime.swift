...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.avaclaw", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.avaclaw", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [AvaClawChatMessage] = messages.compactMap { item in
