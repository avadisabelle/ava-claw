...
enum AvaClawConfigFile {
    private static let logger = Logger(subsystem: "ai.avaclaw", category: "config")
    ...
    static func stateDirURL() -> URL {
        AvaClawPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        AvaClawPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-avaclaw-config-file",
            "event": "config.write",
