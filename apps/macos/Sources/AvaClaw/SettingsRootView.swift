...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .avaclawSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? AvaClawPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? AvaClawPaths.stateDirURL.path
...
extension Notification.Name {
    static let avaclawSelectSettingsTab = Notification.Name("avaclawSelectSettingsTab")
}
