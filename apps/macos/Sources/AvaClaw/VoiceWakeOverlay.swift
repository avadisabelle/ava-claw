...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.avaclaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other AvaClaw windows, but below the system’s pop-up menus.
