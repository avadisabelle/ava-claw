...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.avaclaw", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".avaclaw/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.avaclawCommand(
            subcommand: "gateway",
