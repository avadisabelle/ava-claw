...
enum ModelCatalogLoader {
    ...
    private static let logger = Logger(subsystem: "ai.avaclaw", category: "models")
    ...
    private static func nodeModulesCatalogPath() -> String? {
        ...
        for root in roots {
            let candidate = root
                .appendingPathComponent("node_modules/@avadisabelle/ava-pi-ai/dist/models.generated.js")
