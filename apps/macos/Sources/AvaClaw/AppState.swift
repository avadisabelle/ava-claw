...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = AvaClawConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = AvaClawConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: AvaClawConfigFile.loadDict(),
        ...
        AvaClawConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/avaclaw"
        state.remoteCliPath = ""
        return state
    }
}
