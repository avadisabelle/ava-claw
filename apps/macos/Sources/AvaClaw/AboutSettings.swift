...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/avaclaw/avaclaw") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/avaclaw/avaclaw")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://avaclaw.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "AvaClawBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "AvaClawBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "AvaClawGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "AvaClawGitCommit") as? String) ??
            "unknown"
    }
