...
/// Menu contents for the AvaClaw menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About AvaClaw") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "AvaClaw Not Configured"
        case .remote:
            "Remote AvaClaw Active"
        case .local:
            "AvaClaw Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .avaclawSelectSettingsTab, object: tab)
        }
    }
