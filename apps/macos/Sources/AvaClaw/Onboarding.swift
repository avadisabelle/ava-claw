...
enum UIStrings {
    static let welcomeTitle = "Welcome to AvaClaw"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "avaclaw.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: AvaClawChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g avaclaw@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: AvaClawChatViewModel(
