...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.avaclaw", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("AvaClaw/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__avaclaw__/a2ui/").absoluteString + "?platform=macos"
    }
