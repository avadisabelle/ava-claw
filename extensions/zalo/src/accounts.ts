...
import { createAccountListHelpers, type AvaClawConfig } from "avaclaw/plugin-sdk/zalo";
...
function mergeZaloAccountConfig(cfg: AvaClawConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: AvaClawConfig): ResolvedZaloAccount[] {
