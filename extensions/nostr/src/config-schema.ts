import { AllowFromListSchema, DmPolicySchema } from "avaclaw/plugin-sdk/compat";
import { MarkdownConfigSchema, buildChannelConfigSchema } from "avaclaw/plugin-sdk/nostr";
import { z } from "zod";
