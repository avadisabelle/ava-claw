...
Before:
AvaClaw supports plugins.

After:
AvaClaw supports plugins and hosted diff views.
```
...
- Artifacts are ephemeral and stored in the plugin temp subfolder (`$TMPDIR/avaclaw-diffs`).
