import type {
  ...
  DmPolicy,
  WizardPrompter,
} from "avaclaw/plugin-sdk/bluebubbles";
import {
  DEFAULT_ACCOUNT_ID,
  formatDocsLink,
...
function setBlueBubblesDmPolicy(cfg: AvaClawConfig, dmPolicy: DmPolicy): AvaClawConfig {
  ...
  configure: async ({ cfg, prompter, accountOverrides, shouldPromptAccountIds }) => {
    ...
    await prompter.note(
      [
        ...
        "2. Add your AvaClaw gateway URL + webhook path",
