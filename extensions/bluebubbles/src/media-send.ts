...
import { resolveChannelMediaMaxBytes, type AvaClawConfig } from "avaclaw/plugin-sdk/bluebubbles";
...
function resolveMediaLocalRoots(params: { cfg: AvaClawConfig; accountId?: string }): string[] {
