import type { AvaClawConfig } from "avaclaw/plugin-sdk/bluebubbles";
...
function resolveBlueBubblesDebounceMs(config: AvaClawConfig, core: BlueBubblesCoreRuntime): number {
