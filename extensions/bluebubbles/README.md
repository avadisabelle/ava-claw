...
This directory contains the **BlueBubbles external channel plugin** for AvaClaw.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `avaclaw/plugin-sdk` helpers.
