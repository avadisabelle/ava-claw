...
import type { TelegramAccountConfig, TelegramActionConfig } from "avaclaw/plugin-sdk/telegram";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.AVACLAW_DEBUG_TELEGRAM_ACCOUNTS)) {
...
function listConfiguredAccountIds(cfg: AvaClawConfig): string[] {
...
export function listTelegramAccountIds(cfg: AvaClawConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: AvaClawConfig): string {
...
export function mergeTelegramAccountConfig(
  ...
  // See: https://github.com/avadisabelle/ava-claw/issues/30673
...
export function listEnabledTelegramAccounts(cfg: AvaClawConfig): ResolvedTelegramAccount[] {
