...
export function mergeSlackAccountConfig(cfg: AvaClawConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: AvaClawConfig): ResolvedSlackAccount[] {
