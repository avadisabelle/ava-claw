...
import { isSecretRef } from "avaclaw/plugin-sdk/googlechat";
import { createAccountListHelpers, type AvaClawConfig } from "avaclaw/plugin-sdk/googlechat";
...
export function listEnabledGoogleChatAccounts(cfg: AvaClawConfig): ResolvedGoogleChatAccount[] {
