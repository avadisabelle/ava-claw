import type { AvaClawConfig, PluginRuntime, ResolvedLineAccount } from "avaclaw/plugin-sdk/line";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: AvaClawConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: AvaClawConfig; accountId: string }): Promise<{
