import type { LineChannelData, AvaClawPluginApi, ReplyPayload } from "avaclaw/plugin-sdk/line";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: AvaClawPluginApi): void {
  api.registerCommand({
    name: "card",
