...
import type { AvaClawPluginApi } from "avaclaw/plugin-sdk/feishu";
...
function readConfiguredDefaultAccountId(config: AvaClawPluginApi["config"]): string | undefined {
...
export function resolveFeishuToolAccount(params: {
  api: Pick<AvaClawPluginApi, "config">;
