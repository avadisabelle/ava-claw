import type {
  ...
  PluginLogger,
} from "avaclaw/plugin-sdk/acpx";
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "avaclaw/plugin-sdk/acpx";
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: AvaClawPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: AvaClawPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
