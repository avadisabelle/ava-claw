import type { AvaClawConfig, AvaClawPluginApi } from "avaclaw/plugin-sdk/thread-ownership";
...
function resolveOwnershipAgent(config: AvaClawConfig): { id: string; name: string } {
