...
} from "avaclaw/plugin-sdk/whatsapp";
...
export function listWhatsAppAuthDirs(cfg: AvaClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: AvaClawConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: AvaClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: AvaClawConfig): ResolvedWhatsAppAccount[] {
