import { normalizeAccountId, type IMessageAccountConfig } from "avaclaw/plugin-sdk/imessage";
...
function mergeIMessageAccountConfig(cfg: AvaClawConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: AvaClawConfig): ResolvedIMessageAccount[] {
