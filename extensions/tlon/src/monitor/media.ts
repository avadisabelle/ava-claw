...
import { fetchWithSsrFGuard } from "avaclaw/plugin-sdk/tlon";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to AvaClaw workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".avaclaw", "workspace", "media", "inbound");
 ...
 * Format matches AvaClaw's expected attachment structure.
 */
