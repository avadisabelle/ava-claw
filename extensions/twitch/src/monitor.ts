...
import type { ReplyPayload, AvaClawConfig } from "avaclaw/plugin-sdk/twitch";
import { createReplyPrefixOptions } from "avaclaw/plugin-sdk/twitch";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as AvaClawConfig;
