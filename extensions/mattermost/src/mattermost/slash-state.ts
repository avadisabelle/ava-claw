...
import type { AvaClawPluginApi } from "avaclaw/plugin-sdk/mattermost";
...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("avaclaw/plugin-sdk/mattermost").AvaClawConfig;
    runtime: import("avaclaw/plugin-sdk/mattermost").RuntimeEnv;
  };
  log?: (msg: string) => void;
}) {
 ...
 */
export function registerSlashCommandRoute(api: AvaClawPluginApi) {
