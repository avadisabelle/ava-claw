...
import { createAccountListHelpers, type AvaClawConfig } from "avaclaw/plugin-sdk/mattermost";
...
export function listEnabledMattermostAccounts(cfg: AvaClawConfig): ResolvedMattermostAccount[] {
