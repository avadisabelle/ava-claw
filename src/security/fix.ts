...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof AvaClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: AvaClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: AvaClawConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
