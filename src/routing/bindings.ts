...
export function listBindings(cfg: AvaClawConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: AvaClawConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: AvaClawConfig) {
