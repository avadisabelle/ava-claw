/**
 * Hook system for AvaClaw agent events
 *
...
const _g = globalThis as typeof globalThis & {
  __avaclaw_internal_hook_handlers__?: Map<string, InternalHookHandler[]>;
};
const handlers = (_g.__avaclaw_internal_hook_handlers__ ??= new Map<
  string,
  InternalHookHandler[]
>());
