 ...
 * returning control to the caller (typically `triggerAvaClawRestart` →
...
/**
 * Parse avaclaw gateway PIDs from lsof -Fpc stdout.
 ...
 * Returns only PIDs that belong to avaclaw gateway processes (not the current process).
 */
