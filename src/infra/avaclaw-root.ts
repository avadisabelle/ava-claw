...
const CORE_PACKAGE_NAMES = new Set(["@avadisabelle/ava-claw", "avaclaw"]);
...
export async function resolveAvaClawPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveAvaClawPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
