...
const ensureAvaClawModelsJsonMock = vi.fn(async () => {});
...
vi.mock("../../agents/models-config.js", () => ({
  ensureAvaClawModelsJson: ensureAvaClawModelsJsonMock,
}));
...
describe("describeImageWithModel", () => {
  ...
  it("routes minimax-portal image models through the MiniMax VLM endpoint", async () => {
    ...
    expect(ensureAvaClawModelsJsonMock).toHaveBeenCalled();
