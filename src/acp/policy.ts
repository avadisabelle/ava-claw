...
export function isAcpEnabledByPolicy(cfg: AvaClawConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: AvaClawConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: AvaClawConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: AvaClawConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: AvaClawConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: AvaClawConfig, agentId: string): boolean {
