...
type ConfiguredBinding = NonNullable<AvaClawConfig["bindings"]>[number];
...
function resolveBindingRecord(cfg: AvaClawConfig, overrides: Partial<BindingRecordInput> = {}) {
