    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["avaclaw directory self --channel slack", "Show the connected account identity."],
          [
            'avaclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["avaclaw directory groups list --channel discord", "List available groups/channels."],
          [
            "avaclaw directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.avaclaw.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
