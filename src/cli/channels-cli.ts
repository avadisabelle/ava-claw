    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["avaclaw channels list", "List configured channels and auth profiles."],
          ["avaclaw channels status --probe", "Run channel status checks and probes."],
          [
            "avaclaw channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["avaclaw channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.avaclaw.ai/cli/channels",
        )}\n`,
    );
