...
const SANDBOX_EXAMPLES = {
  main: [
    ["avaclaw sandbox list", "List all sandbox containers."],
    ["avaclaw sandbox list --browser", "List only browser containers."],
    ["avaclaw sandbox recreate --all", "Recreate all containers."],
    ["avaclaw sandbox recreate --session main", "Recreate a specific session."],
    ["avaclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["avaclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["avaclaw sandbox list", "List all sandbox containers."],
    ["avaclaw sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["avaclaw sandbox recreate --all", "Recreate all containers."],
    ["avaclaw sandbox recreate --session main", "Recreate a specific session."],
    ["avaclaw sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["avaclaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["avaclaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["avaclaw sandbox explain", "Show effective sandbox config."],
    ["avaclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["avaclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["avaclaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.avaclaw.ai/cli/sandbox")}\n`,
    )
    .action(() => {
