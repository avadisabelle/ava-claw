import type { BrowserConfig, BrowserProfileConfig, AvaClawConfig } from "../config/config.js";
...
import {
  ...
  DEFAULT_AVACLAW_BROWSER_ENABLED,
...
function normalizeHexColor(raw: string | undefined) {
  ...
  if (!value) {
    return DEFAULT_AVACLAW_BROWSER_COLOR;
  }
...
/**
 * Ensure the default "avaclaw" profile exists in the profiles map.
...
function ensureDefaultProfile(
  ...
  if (!result[DEFAULT_AVACLAW_BROWSER_PROFILE_NAME]) {
    result[DEFAULT_AVACLAW_BROWSER_PROFILE_NAME] = {
...
export function resolveBrowserConfig(
  ...
  const enabled = cfg?.enabled ?? DEFAULT_AVACLAW_BROWSER_ENABLED;
  ...
  const defaultProfile =
    ...
    (profiles[DEFAULT_BROWSER_DEFAULT_PROFILE_NAME]
      ? DEFAULT_BROWSER_DEFAULT_PROFILE_NAME
      : profiles[DEFAULT_AVACLAW_BROWSER_PROFILE_NAME]
        ? DEFAULT_AVACLAW_BROWSER_PROFILE_NAME
        : "user");
