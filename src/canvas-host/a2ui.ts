...
export const A2UI_PATH = "/__avaclaw__/a2ui";

export const CANVAS_HOST_PATH = "/__avaclaw__/canvas";

export const CANVAS_WS_PATH = "/__avaclaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.avaclawCanvasA2UIAction.postMessage(...)
  // - Android: window.avaclawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["avaclawCanvasA2UIAction"];
  ...
  globalThis.AvaClaw = globalThis.AvaClaw ?? {};
  globalThis.AvaClaw.postMessage = postToNode;
  globalThis.AvaClaw.sendUserAction = sendUserAction;
  globalThis.avaclawPostMessage = postToNode;
  globalThis.avaclawSendUserAction = sendUserAction;
