...
import type {
  AvaClawPluginApi,
  AvaClawPluginChannelRegistration,
  AvaClawPluginCliRegistrar,
  AvaClawPluginCommandDefinition,
  AvaClawPluginHttpRouteAuth,
  AvaClawPluginHttpRouteMatch,
  AvaClawPluginHttpRouteHandler,
  AvaClawPluginHttpRouteParams,
  AvaClawPluginHookOptions,
  ProviderPlugin,
  AvaClawPluginService,
  AvaClawPluginToolContext,
...
export type PluginToolRegistration = {
  pluginId: string;
  pluginName?: string;
  factory: AvaClawPluginToolFactory;
  names: string[];
  optional: boolean;
  source: string;
  rootDir?: string;
...
export type PluginCliRegistration = {
  pluginId: string;
  pluginName?: string;
  register: AvaClawPluginCliRegistrar;
  commands: string[];
  source: string;
  rootDir?: string;
};
...
export type PluginCommandRegistration = {
  pluginId: string;
  pluginName?: string;
  command: AvaClawPluginCommandDefinition;
  source: string;
  rootDir?: string;
};
...
export function createPluginRegistry(registryParams: PluginRegistryParams) {
  ...
  const registerTool = (
    ...
    const factory: AvaClawPluginToolFactory =
      typeof tool === "function" ? tool : (_ctx: AvaClawPluginToolContext) => tool;
  ...
  const registerHook = (
    ...
    opts: AvaClawPluginHookOptions | undefined,
    config: AvaClawPluginApi["config"],
  ) => {
  ...
  const registerHttpRoute = (record: PluginRecord, params: AvaClawPluginHttpRouteParams) => {
  ...
  const registerChannel = (
    record: PluginRecord,
    registration: AvaClawPluginChannelRegistration | ChannelPlugin,
    mode: PluginRegistrationMode = "full",
  ) => {
    const normalized =
      typeof (registration as AvaClawPluginChannelRegistration).plugin === "object"
        ? (registration as AvaClawPluginChannelRegistration)
  ...
  const registerCli = (
    record: PluginRecord,
    registrar: AvaClawPluginCliRegistrar,
  ...
  const registerService = (record: PluginRecord, service: AvaClawPluginService) => {
  ...
  const registerCommand = (record: PluginRecord, command: AvaClawPluginCommandDefinition) => {
