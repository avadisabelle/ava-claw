...
vi.mock("./loader.js", () => ({
  loadAvaClawPlugins: (...args: unknown[]) => mocks.loadAvaClawPlugins(...args),
}));
...
describe("registerPluginCliCommands", () => {
  beforeEach(() => {
    ...
    mocks.loadAvaClawPlugins.mockReturnValue({
      cliRegistrars: [
        {
  ...
  it("forwards an explicit env to plugin loading", () => {
    ...
    registerPluginCliCommands(program, {} as AvaClawConfig, env);

    expect(mocks.loadAvaClawPlugins).toHaveBeenCalledWith(
