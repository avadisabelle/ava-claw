...
export const PLUGIN_MANIFEST_FILENAME = "avaclaw.plugin.json";
...
// package.json "avaclaw" metadata (used for onboarding/catalog)
...
export type AvaClawPackageManifest = {
  extensions?: string[];
...
): AvaClawPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
