...
function resolveResolutionLimits(config: AvaClawConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: AvaClawConfig): SecretProviderConfig {
