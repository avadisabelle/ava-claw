...
export function listAuthProfileStorePaths(config: AvaClawConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: AvaClawConfig, stateDir: string): string[] {
