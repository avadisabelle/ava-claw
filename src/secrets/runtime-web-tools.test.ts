...
async function runRuntimeWebTools(params: { config: AvaClawConfig; env?: NodeJS.ProcessEnv }) {
...
function readProviderKey(config: AvaClawConfig, provider: ProviderUnderTest): unknown {
  if (provider === "brave") {
