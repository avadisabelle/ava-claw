...
function expectLaunchctlEnableBootstrapOrder(env: Record<string, string | undefined>) {
  ...
  const label = "ai.avaclaw.gateway";
...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.avaclaw.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", AVACLAW_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.avaclaw.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when AVACLAW_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.avaclaw.gateway.plist",
    },
    {
      name: "uses profile-specific label when AVACLAW_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", AVACLAW_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.avaclaw.jbphoenix.plist",
    },
    {
      name: "prefers AVACLAW_LAUNCHD_LABEL over AVACLAW_PROFILE",
      env: {
        HOME: "/Users/test",
        AVACLAW_PROFILE: "jbphoenix",
        AVACLAW_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from AVACLAW_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        AVACLAW_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty AVACLAW_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        AVACLAW_PROFILE: "myprofile",
        AVACLAW_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.avaclaw.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
