...
export function resolveSubagentToolPolicy(cfg?: AvaClawConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: AvaClawConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: AvaClawConfig["tools"];
