...
async function resolveContext(config: AvaClawConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): AvaClawConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
