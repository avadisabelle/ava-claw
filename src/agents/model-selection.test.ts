...
function resolveAnthropicOpusThinking(cfg: AvaClawConfig) {
...
function createProviderWithModelsConfig(provider: string, models: Array<Record<string, unknown>>) {
  ...
  } as Partial<AvaClawConfig>;
}

function resolveConfiguredRefForTest(cfg: Partial<AvaClawConfig>) {
...
describe("model-selection", () => {
  ...
  describe("buildModelAliasIndex", () => {
    it("should build alias index from config", () => {
      const cfg: Partial<AvaClawConfig> = {
        agents: {
          defaults: {
            models: {
