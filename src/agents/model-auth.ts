...
import { type Api, getEnvApiKey, type Model } from "@avadisabelle/ava-pi-ai";
...
export async function resolveApiKeyForProvider(params: {
  ...
  throw new Error(
    [
      ...
      `Configure auth for this agent (${formatCliCommand("avaclaw agents add <id>")}) or copy auth-profiles.json from the main agentDir.`,
    ].join(" "),
  );
}
