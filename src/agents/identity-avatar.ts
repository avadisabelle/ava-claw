...
function resolveAvatarSource(cfg: AvaClawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: AvaClawConfig, agentId: string): AgentAvatarResolution {
