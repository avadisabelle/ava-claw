...
const CLEANUP_STATE_KEY = Symbol.for("avaclaw.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("avaclaw.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("avaclaw.sessionWriteLockWatchdogState");
