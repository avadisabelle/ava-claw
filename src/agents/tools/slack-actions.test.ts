...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): AvaClawConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: AvaClawConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: AvaClawConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
