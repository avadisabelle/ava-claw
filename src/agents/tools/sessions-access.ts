...
export function resolveSessionToolsVisibility(cfg: AvaClawConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: AvaClawConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: AvaClawConfig): AgentToAgentPolicy {
