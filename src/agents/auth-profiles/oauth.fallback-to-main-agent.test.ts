...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveAvaClawAgentDir() returns mainAgentDir
    process.env.AVACLAW_STATE_DIR = tmpDir;
    process.env.AVACLAW_AGENT_DIR = mainAgentDir;
