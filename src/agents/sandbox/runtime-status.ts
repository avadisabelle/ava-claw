...
function resolveMainSessionKeyForSandbox(params: { cfg?: AvaClawConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: AvaClawConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(
    `- See: ${formatCliCommand(`avaclaw sandbox explain --session ${runtime.sessionKey}`)}`,
  );
