...
export const DEFAULT_SANDBOX_IMAGE = "avaclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "avaclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "avaclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "avaclaw-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "avaclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "avaclaw-sandbox-browser";
