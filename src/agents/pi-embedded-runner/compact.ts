...
function resolvePostCompactionIndexSyncMode(config?: AvaClawConfig): "off" | "async" | "await" {
...
export async function compactEmbeddedPiSessionDirect(
  ...
  await ensureAvaClawModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createAvaClawCodingTools({
      exec: {
