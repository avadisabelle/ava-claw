...
function resolveAdaptiveReadMaxBytes(options?: AvaClawReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createAvaClawReadTool(base, {
...
export function createAvaClawReadTool(
  base: AnyAgentTool,
  options?: AvaClawReadToolOptions,
): AnyAgentTool {
