...
describe("setupOnboardingShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("avaclaw");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "avaclaw");
