...
const gatewayEnv = {
  AVACLAW_GATEWAY_TOKEN: "env-token", // pragma: allowlist secret
  AVACLAW_GATEWAY_PASSWORD: "env-password", // pragma: allowlist secret
} as NodeJS.ProcessEnv;

function makeRemoteGatewayConfig(remote: { token?: string; password?: string }): AvaClawConfig {
  return {
    gateway: {
      mode: "remote",
      remote,
