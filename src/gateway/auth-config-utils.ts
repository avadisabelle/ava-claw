import type { GatewayAuthConfig, AvaClawConfig } from "../config/config.js";
import { resolveSecretInputRef } from "../config/types.secrets.js";
import { resolveRequiredConfiguredSecretRefInputString } from "./resolve-configured-secret-input-string.js";

export function withGatewayAuthPassword(cfg: AvaClawConfig, password: string): AvaClawConfig {
  return {
    ...cfg,
    gateway: {
      ...cfg.gateway,
