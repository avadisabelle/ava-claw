...
describe("gateway auth", () => {
  ...
  it("resolves token/password from AVACLAW gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          AVACLAW_GATEWAY_TOKEN: "env-token",
          AVACLAW_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides AVACLAW_GATEWAY_PASSWORD", () => {
