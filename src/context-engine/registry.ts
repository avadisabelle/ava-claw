...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("avaclaw.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: AvaClawConfig): Promise<ContextEngine> {
