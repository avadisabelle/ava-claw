...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: AvaClawConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: AvaClawConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: AvaClawConfig) => string;
  setAccountEnabled?: (params: {
    cfg: AvaClawConfig;
    accountId: string;
    enabled: boolean;
  }) => AvaClawConfig;
  deleteAccount?: (params: { cfg: AvaClawConfig; accountId: string }) => AvaClawConfig;
  isEnabled?: (account: ResolvedAccount, cfg: AvaClawConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: AvaClawConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: AvaClawConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: AvaClawConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: AvaClawConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.avaclaw.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: AvaClawConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
