...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: AvaClawConfig): string | undefined {
  ...
  function listAccountIds(cfg: AvaClawConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: AvaClawConfig): string {
