...
export function listChannelMessageActions(cfg: AvaClawConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: AvaClawConfig): boolean {
...
export function supportsChannelMessageCards(cfg: AvaClawConfig): boolean {
