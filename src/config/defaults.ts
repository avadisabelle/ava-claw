...
function resolveAnthropicDefaultAuthMode(cfg: AvaClawConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: AvaClawConfig): AvaClawConfig {
...
export function applyTalkApiKey(config: AvaClawConfig): AvaClawConfig {
...
export function applyTalkConfigNormalization(config: AvaClawConfig): AvaClawConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: AvaClawConfig): AvaClawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: AvaClawConfig): AvaClawConfig {
...
export function applyLoggingDefaults(cfg: AvaClawConfig): AvaClawConfig {
...
export function applyContextPruningDefaults(cfg: AvaClawConfig): AvaClawConfig {
...
export function applyCompactionDefaults(cfg: AvaClawConfig): AvaClawConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
