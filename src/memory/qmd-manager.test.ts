...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: AvaClawConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: AvaClawConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__avaclawMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__avaclawMcporterColdStartWarned;
  });
