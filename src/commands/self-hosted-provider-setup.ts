...
export function applyProviderDefaultModel(cfg: AvaClawConfig, modelRef: string): AvaClawConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  maxTokens?: number;
}): { config: AvaClawConfig; modelId: string; modelRef: string; profileId: string } {
