...
function resolveDefaultAccountId(cfg: AvaClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: AvaClawConfig): boolean {
...
export function summarizeBindings(cfg: AvaClawConfig, bindings: AgentBinding[]): string[] {
