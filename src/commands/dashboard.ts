...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set AVACLAW_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `avaclaw dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control AvaClaw.");
  } else if (hint) {
    runtime.log(hint);
  }
}
