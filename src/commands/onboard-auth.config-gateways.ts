...
export function applyVercelAiGatewayProviderConfig(cfg: AvaClawConfig): AvaClawConfig {
...
export function applyVercelAiGatewayConfig(cfg: AvaClawConfig): AvaClawConfig {
