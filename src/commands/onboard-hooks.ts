...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.avaclaw.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("avaclaw hooks list")}`,
      `  ${formatCliCommand("avaclaw hooks enable <name>")}`,
      `  ${formatCliCommand("avaclaw hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
