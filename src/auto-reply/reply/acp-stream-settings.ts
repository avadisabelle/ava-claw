...
function resolveAcpStreamCoalesceIdleMs(cfg: AvaClawConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: AvaClawConfig): number {
...
export function resolveAcpProjectionSettings(cfg: AvaClawConfig): AcpProjectionSettings {
