...
import { CURRENT_SESSION_VERSION, SessionManager } from "@avadisabelle/ava-pi-coding-agent";
...
export function resolveParentForkMaxTokens(cfg: AvaClawConfig): number {
