...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@avaclaw", { botUsername: "avaclaw" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@avaclaw args", {
        botUsername: "avaclaw",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "avaclaw" })).toBe(
      "/help@otherbot",
    );
  });
