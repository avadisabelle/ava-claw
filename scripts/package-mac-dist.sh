...
# Output:
# - dist/AvaClaw.app
# - dist/AvaClaw-<version>.zip
# - dist/AvaClaw-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.avaclaw.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/AvaClaw.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/AvaClaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/AvaClaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/AvaClaw-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/AvaClaw-$VERSION.dSYM.zip"
