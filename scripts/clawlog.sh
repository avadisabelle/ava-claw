...
show_usage() {
    cat << EOF
clawlog - AvaClaw Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View AvaClaw logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    AvaClaw logs flow through the macOS unified log (subsystem: ai.avaclaw).
