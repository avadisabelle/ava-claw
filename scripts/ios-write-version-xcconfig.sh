...
- AVACLAW_GATEWAY_VERSION = exact package.json version
- AVACLAW_MARKETING_VERSION = short iOS/App Store version
- AVACLAW_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
AVACLAW_GATEWAY_VERSION = ${PACKAGE_VERSION}
AVACLAW_MARKETING_VERSION = ${MARKETING_VERSION}
AVACLAW_BUILD_VERSION = ${BUILD_NUMBER}
EOF
