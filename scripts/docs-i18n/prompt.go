...
- Keep product names in English: AvaClaw, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the AvaClaw Gateway, use “Gateway 网关”.
