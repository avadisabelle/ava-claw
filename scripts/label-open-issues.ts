...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "avaclaw", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for AvaClaw. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("AvaClaw Issue Label Audit");
