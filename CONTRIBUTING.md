# Contributing to AvaClaw

Welcome to the lobster tank! 🦞

## Quick Links

- **GitHub:** https://github.com/avadisabelle/ava-claw
- **Vision:** [`VISION.md`](VISION.md)
- **Discord:** https://discord.gg/qkhbAGHRBT
- **X/Twitter:** [@steipete](https://x.com/steipete) / [@avaclaw](https://x.com/avaclaw)
...
2. **New features / architecture** → Start a [GitHub Discussion](https://github.com/avadisabelle/ava-claw/discussions) or ask in Discord first
...
- Test locally with your AvaClaw instance
...
- **Skills**: For skill contributions, head to [ClawHub](https://clawhub.ai/) — the community hub for AvaClaw skills.
- **Performance**: Optimizing token usage and compaction logic.

Check the [GitHub Issues](https://github.com/avadisabelle/ava-claw/issues) for "good first issue" labels!

## Maintainers

We're selectively expanding the maintainer team.
If you're an experienced contributor who wants to help shape AvaClaw's direction — whether through code, docs, or community — we'd like to hear from you.

Being a maintainer is a responsibility, not an honorary title. We expect active, consistent involvement — triaging issues, reviewing PRs, and helping move the project forward.

Still interested? Email contributing@avaclaw.ai with:

- Links to your PRs on AvaClaw (if you don't have any, start there first)
...
For issues that don't fit a specific repo, or if you're unsure, email **security@avaclaw.ai** and we'll route it.
