...
- Same path: run the app from a fixed location (for AvaClaw, `dist/AvaClaw.app`).
...
Workaround: move files into the AvaClaw workspace (`~/.avaclaw/workspace`) if you want to avoid per-folder grants.
