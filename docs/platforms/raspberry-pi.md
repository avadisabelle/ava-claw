---
summary: "Ava-Claw on Raspberry Pi (budget self-hosted setup)"
read_when:
  - Setting up Ava-Claw on a Raspberry Pi
  - Running Ava-Claw on ARM devices
  - Building a cheap always-on personal AI
title: "Raspberry Pi"
---

# Ava-Claw on Raspberry Pi

## Goal

Run a persistent, always-on Ava-Claw Gateway on a Raspberry Pi for **~$35-80** one-time cost (no monthly fees).
...
If this Pi is mostly running Ava-Claw, add a service drop-in to reduce restart
...
Most Ava-Claw features work on ARM64, but some external binaries may need ARM builds:
