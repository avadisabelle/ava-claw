---
summary: "AvaClaw on Raspberry Pi (budget self-hosted setup)"
read_when:
  - Setting up AvaClaw on a Raspberry Pi
  - Running AvaClaw on ARM devices
  - Building a cheap always-on personal AI
title: "Raspberry Pi"
---

# AvaClaw on Raspberry Pi

## Goal

Run a persistent, always-on AvaClaw Gateway on a Raspberry Pi for **~$35-80** one-time cost (no monthly fees).
...
## 9) Access the AvaClaw Dashboard
...
If this Pi is mostly running AvaClaw, add a service drop-in to reduce restart
...
If possible, keep AvaClaw state/cache on SSD-backed storage to avoid SD-card
...
Most AvaClaw features work on ARM64, but some external binaries may need ARM builds:
