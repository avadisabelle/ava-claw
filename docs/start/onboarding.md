---
summary: "First-run onboarding flow for Ava-Claw (macOS app)"
read_when:
...
- By default, Ava-Claw is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give Ava-Claw">
...
<Step title="CLI">
  ...
  The app can install the global `avaclaw` CLI via npm/pnpm so terminal
