---
summary: "Backstory and lore of Ava-Claw for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "Ava-Claw Lore"
---

# The Lore of Ava-Claw 🦞📖
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **Ava-Claw**.
...
In the end, **Ava-Claw** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
The **Moltiverse** is the community and ecosystem around Ava-Claw. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at Ava-Claw" to promote pump-and-dump tokens.
...
**The Great Ava-Claw Migration** began.
