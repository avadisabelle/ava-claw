...
- 生成的 Swift 模型：`apps/macos/Sources/Ava-ClawProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/avadisabelle/ava-claw/main/dist/protocol.schema.json
