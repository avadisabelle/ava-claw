...
```bash
curl -fsSL https://raw.githubusercontent.com/avadisabelle/ava-claw-ansible/main/install.sh | bash
```

> **📦 完整指南：[github.com/avadisabelle/ava-claw-ansible](https://github.com/avadisabelle/ava-claw-ansible)**
>
> avaclaw-ansible 仓库是 Ansible 部署的权威来源。本页是快速概述。
...
# 或直接运行（然后手动执行 /tmp/avaclaw-setup.sh）
...
- [安全架构](https://github.com/avadisabelle/ava-claw-ansible/blob/main/docs/security.md)
- [技术详情](https://github.com/avadisabelle/ava-claw-ansible/blob/main/docs/architecture.md)
- [故障排除指南](https://github.com/avadisabelle/ava-claw-ansible/blob/main/docs/troubleshooting.md)

## 相关内容

- [avaclaw-ansible](https://github.com/avadisabelle/ava-claw-ansible) — 完整部署指南
