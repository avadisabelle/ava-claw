...
本指南总结了在 Ava-Claw 中开发 Pi 集成的合理工作流程。
...
状态存储在 Ava-Claw 状态目录下。默认为 `~/.avaclaw`。如果设置了 `AVACLAW_STATE_DIR`，则使用该目录。
...
- https://docs.avaclaw.ai/testing
- https://docs.avaclaw.ai/start/getting-started
