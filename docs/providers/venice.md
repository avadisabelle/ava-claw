---
summary: "Use Venice AI privacy-focused models in Ava-Claw"
read_when:
  - You want privacy-focused inference in Ava-Claw
...
After setup, Ava-Claw shows all available Venice models. Pick based on your needs:
...
Ava-Claw automatically discovers models from the Venice API when `VENICE_API_KEY` is set. If the API is unreachable, it falls back to a static catalog.
