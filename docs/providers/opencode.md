---
summary: "Use OpenCode Zen and Go catalogs with Ava-Claw"
read_when:
...
OpenCode exposes two hosted catalogs in Ava-Claw:

- `opencode/...` for the **Zen** catalog
- `opencode-go/...` for the **Go** catalog

Both catalogs use the same OpenCode API key. Ava-Claw keeps the runtime provider ids
