---
summary: "Use OpenCode Zen and Go catalogs with AvaClaw"
read_when:
...
OpenCode exposes two hosted catalogs in AvaClaw:

- `opencode/...` for the **Zen** catalog
- `opencode-go/...` for the **Go** catalog

Both catalogs use the same OpenCode API key. AvaClaw keeps the runtime provider ids
