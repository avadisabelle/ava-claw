---
summary: "Use Synthetic's Anthropic-compatible API in Ava-Claw"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Ava-Claw registers it as the
...
Note: Ava-Claw's Anthropic client appends `/v1` to the base URL, so use
