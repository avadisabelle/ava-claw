---
summary: "Use Synthetic's Anthropic-compatible API in AvaClaw"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. AvaClaw registers it as the
...
Note: AvaClaw's Anthropic client appends `/v1` to the base URL, so use
