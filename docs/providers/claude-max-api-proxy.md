...
You can point AvaClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or AvaClaw
...
- [Anthropic provider](/providers/anthropic) - Native AvaClaw integration with Claude setup-token or API keys
