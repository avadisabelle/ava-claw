---
summary: "Use Qianfan's unified API to access many models in AvaClaw"
read_when:
...
3. AvaClaw installed on your system
...
4. Copy the API key for use with AvaClaw
...
- [AvaClaw Configuration](/gateway/configuration)
