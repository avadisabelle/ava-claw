---
summary: "Use Qianfan's unified API to access many models in Ava-Claw"
read_when:
...
3. Ava-Claw installed on your system
...
4. Copy the API key for use with Ava-Claw
...
- [Ava-Claw Configuration](/gateway/configuration)
