...
- Install via CLI: `avaclaw plugins install ava-claw-zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `avaclaw plugins install ./extensions/zalo`
   - From npm (if published): `avaclaw plugins install ava-claw-zalo`
...
This page reflects current AvaClaw behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `avaclaw pairing list zalo`
  - `avaclaw pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in AvaClaw.
...
- Example: `avaclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `avaclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `avaclaw logs --follow`
