...
Tlon is a decentralized messenger built on Urbit. Ava-Claw connects to your Urbit ship and can
...
By default, Ava-Claw blocks private/internal hostnames and IP ranges for SSRF protection.
...
- Thread replies: if the inbound message is in a thread, Ava-Claw replies in-thread.
