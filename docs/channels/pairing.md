...
read_when:
  ...
  - Reviewing Ava-Claw security posture
title: "Pairing"
---

# Pairing

“Pairing” is Ava-Claw’s explicit **owner approval** step.
...
Stored under `~/.avaclaw/credentials/`:
...
3. On your phone, open the Ava-Claw iOS app → Settings → Gateway.
...
- The legacy `node.pair.*` API (CLI: `avaclaw nodes pending/approve`) is a
