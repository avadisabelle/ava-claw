...
read_when:
  - You want Ava-Claw to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables Ava-Claw to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`avaclaw onboard`) and `avaclaw channels add` list optional channel plugins.
...
```bash
avaclaw plugins install --link <path-to-avaclaw>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "avaclaw",
        "displayName": "Ava-Claw",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "avaclaw@example.com",
        "lud16": "avaclaw@example.com"
      }
    }
  }
}
