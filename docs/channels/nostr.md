...
read_when:
  - You want AvaClaw to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables AvaClaw to receive and respond to encrypted direct messages (DMs) via NIP-04.
