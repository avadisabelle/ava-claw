    ...
    <div class="login-gate">
      ...
      <div class="login-gate__card">
        <div class="login-gate__header">
          <img class="login-gate__logo" src=${faviconSrc} alt="AvaClaw" />
          <div class="login-gate__title">AvaClaw</div>
          ...
          <label class="field">
            ...
            <div class="login-gate__secret-row">
              <input
                ...
                placeholder="AVACLAW_GATEWAY_TOKEN (${t("login.passwordPlaceholder")})"
